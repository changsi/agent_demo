...
def create_browser_tools(browser, llm, model: str = "gpt-4o-mini"):
    ...
    Returns:
        List of 8 LangGraph-compatible tools
    """
...
Provide a concise answer based only on the page content. If the information is not available, say so."""
    ...
    # Return all 8 tools (removed search_direct - too site-specific)
    return [navigate, click, input_text, extract, send_keys, scroll, screenshot, done]
